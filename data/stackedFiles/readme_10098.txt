...
Sensor(s): 
Keywords: plants, productivity, plant productivity, woody plants, net primary productivity (NPP), carbon cycle, shrubs, vegetation, trees, vst, annual net primary productivity (ANPP), saplings, production, canopy height, lianas, vegetation structure, tree height, biomass
Domain: D19
DATA PACKAGE CONTENTS
---------------------
This folder contains the following documentation files:
This data product contains up to 5 data tables:
- Term descriptions, data types, and units: NEON.D19.DEJU.DP1.10098.001.variables.20230109T190613Z.csv
